...
#   Phuong Tran,11/29/2024,Assignment07
# ------------------------------------------------------------------------------------------ #
import json
...
class Person:
    ...
    ChangeLog:
    Phuong Tran,11.29.2024, Created the class.
    """
    ...
    def first_name(self)->str:
        """
        Return the first name as a title
    ...
    def first_name(self, value:str) -> None:
        """
        Set the first name, while doing validations
    ...
    def last_name(self)->str:
        """
        Return the last name as a title
    ...
    def last_name(self,value:str) -> None:
        """
        Set the last name, while doing validations
        :param value: The value to set
        """
        if value.isalpha():
...
class FileProcessor:
    ...
    Phuong Tran,11.29.2024,Created Class
    """
    @staticmethod
    def read_data_from_file(file_name: str, student_data: list[Student]) -> list[Student]:
        ...
        ChangeLog: (Who, When, What)
        Phuong Tran,11.29.2024,Created function
        ...
        try:
            ...
            IO.output_error_messages("Error while reading the file.", e)
        return student_data
...
class IO:
    ...
    ChangeLog: (Who, When, What)
    Phuong Tran,11.29.2024,Created Class
    Phuong Tran,11.29.2024,Added menu output and input functions
    Phuong Tran,11.29.2024,Added a function to display the data
    Phuong Tran,11.29.2024,Added a function to display custom error messages
    """
